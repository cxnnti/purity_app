...
class DataControllerTest < ActionController::TestCase
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post :create, datum: { email: @datum.email, message: @datum.message, name: @datum.name, phone: @datum.phone }
    end
  ...
  test "should update datum" do
    patch :update, id: @datum, datum: { email: @datum.email, message: @datum.message, name: @datum.name, phone: @datum.phone }
    assert_redirected_to datum_path(assigns(:datum))
  end
